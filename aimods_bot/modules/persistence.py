...
class PostgresPersistence(DictPersistence):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if url:
            ...
            self.conn = connect(url, client_encoding="utf8")
        ...
        try:
            ...
            if not data:
                ...
                self._session.execute(str(insert_qry), [json.dumps({"jsondata": "{}"})])
                self.conn.commit()
    ...
    def __init_database(self) -> None:
        ...
        create_table_qry = """
            ...
            data json NOT NULL);"""
        self._session.execute(str(create_table_qry))
        self.conn.commit()
    ...
    def _update_database(self) -> None:
        ...
        try:
            ...
            insert_qry = "UPDATE persistence SET data = %s"
            params = {"jsondata": self._dump_into_json()}
            self._session.execute(str(insert_qry), [json.dumps(params)])
            self.conn.commit()
