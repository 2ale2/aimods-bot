...
file_handler = logging.FileHandler("aimods_bot/misc/logs/database.log")
...
file_handler = logging.FileHandler("aimods_bot/misc/logs/commands.log")
file_handler.setFormatter(formatter)
...
file_handler = logging.FileHandler("aimods_bot/misc/logs/jobqueue.log")
file_handler.setFormatter(formatter)
